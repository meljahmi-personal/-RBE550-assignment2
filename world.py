...
class GridWorld:
    ...
    def count_junk(self): return int(np.sum(self.grid == JUNK))
    ...
    # ----- rendering -----
    def draw(self, goal, hero, enemies, path=None, save_path="flatland.png", overlay=None):
        n = self.n
        ...
        leg = ax.legend(loc="upper right", frameon=True, fontsize=9); leg.get_frame().set_alpha(0.9)
